...
11. You also need to add the image of the item, I personally use - https://github.com/bitc0de/fivem-items-gallery/tree/main/images add the images into ps-inventory/html/images  <br>
You will also need to add something like "apple = { name = 'apple', label = 'Apple', weight = 100, type = 'item', image = 'apple.png', unique = false, useable = true, shouldClose = false, description = 'An apple'  }, " to qb-core/shared/items.lua
